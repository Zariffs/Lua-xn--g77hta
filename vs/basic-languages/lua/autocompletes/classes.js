			...
			"Color3": {
				__children__: {
					"Function": {
						...
						"fromHex()": {
							insertText: "fromHex(${1:hex})",
							sortText: ".fromHex",
							documentation: {
								value: [
									"```lua\nfunction fromHex(hex: string)\n  -> number\n  2. number\n  3. number\n```",
									"",
									"Returns a new Color3 from a six- or three-character hexadecimal format",
									"",
									"[View documents](https://create.roblox.com/docs/reference/engine/datatypes/Color3#fromHex)",
								].join("\n")
							},
						},
					},
