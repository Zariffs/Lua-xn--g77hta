...
define(["require", "exports"], function (require, exports) {
    ...
    exports.conf = {
        ...
        brackets: [
            ...
            ['[', ']'],
            ['(', ')'],
            //--// dont add things like ['if','then'] cause u gotta add every possible outcome so just dont...
        ],
        autoClosingPairs: [
            { open: '{', close: '}' },
            { open: '[', close: ']' },
    ...
    exports.language = {
        defaultToken: '',
        tokenPostfix: '.lua',
        keywords: 'end and break continue for function if in local not or repeat return then until while next'.split(' '),
        ...
        tokenizer: {
            root: [
                ...
                [/\b(end)\b/, 'keyword.local'],
                [/\b(and|break|continue|do|else|elseif|for|function|if|in|local|not|or|repeat|return|then|until|while|next)\b/, 'keyword'],
